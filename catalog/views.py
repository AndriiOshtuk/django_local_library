...
def index(request):
    ...
    num_genges = Genre.objects.all().count()
    num_specific_books = Book.objects.filter(title__iexact='anna karenina').count()
...
class BorrowedBooksListView(PermissionRequiredMixin,generic.ListView):
    ...
    permission_required = 'catalog.can_view_status'
